...
<body>
  ...
  <form name="addform" onsubmit="return validateForm()" method="post" enctype="multipart/form-data">
...
<script>
  function validateForm() {
    ...
    if (document.forms["addform"]["mail"].value.trim() == "") {
    ...
    var mail =document.addform.mail.value;
